...
(function(){
    ...
    function addHr(){
        ...
        let insertBefore = document.getElementById("contactId")[0];
        let liCreate = document.createElement('li');
        liCreate.innerHTML = `<a id="prod" class="nav-link" aria-current="page" href="products.html"><i class="fas fa-globe" name="prod"></i> Products</a>`
