...
(function(){
    ...
    function addHr(){
        ...
        liCreate.innerHTML = `<a id="prod" class="nav-link" aria-current="page" href="#"><i class="fas fa-globe" name="prod"></i> Human Resources</a>`;

        navIn.insertBefore(liCreate, navIn.getElementsByTagName("li")[3]);
